/* ============================================
   DIA'S CAKES - COMPLETE PREMIUM JAVASCRIPT
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.gift-amount span').forEach(amount => {
        amount.addEventListener('click', function() {
            document.querySelectorAll('.gift-amount span').forEach(a => a.style.background = '#FFF8F0');
    ...
    console.log('DIA\'S CAKES - Premium website loaded successfully!');
